...
async def markets(
    ...
    try:
        ...
        if callable(fallback_catalog):
            ...
            price_sources = {item.get("price_source") for item in data}
            if "Hyperliquid Perpetuals" in price_sources:
                source = "Binance Spot + Hyperliquid"
            elif "Binance Futures" in price_sources:
